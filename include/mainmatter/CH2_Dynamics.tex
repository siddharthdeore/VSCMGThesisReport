...
Starting from initial gimbal angle $\displaystyle \gamma _{0}$ spin and transverse axis as function of $\displaystyle \gamma $ are evaluated in $\displaystyle \mathcal{F}_{b}$ as
\begin{equation}
