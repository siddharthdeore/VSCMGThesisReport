...
\begin{equation}
\omega _{\mathcal{F}_{W} /\mathcal{F}_{g}} =\dot{\delta}\hat{s}
\end{equation}
...
Keeping angular velocity of RW \ $\displaystyle \Omega $ constant in \autoref{eqn:EOM_FULL} we get attitude equation of a satellite equipped with control moment gyros as 
\begin{equation}
\begin{aligned}
