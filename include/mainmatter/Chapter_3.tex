...
\centering
\begin{tabular}{cc}
\subcaptionbox{External Singularity\label{fig:sing_ext}}{\includegraphics[width = 0.5\linewidth]{figures/Singular/sing_ext_3v.eps}} &
\subcaptionbox{Internal Singularity contribution by gimbal\label{fig:sing_int1}}{\includegraphics[width = 0.5\linewidth]{figures/Singular/sing_in_3v_1G.eps}} \\

\subcaptionbox{Internal Singularity of all gimbals\label{fig:sing_int_all}}{\includegraphics[width = 0.5\linewidth]{figures/Singular/sing_in_all3v.eps}} &
\subcaptionbox{Singularities Combined\label{fig:sing_allOpq}}{\includegraphics[width = 0.5\linewidth]{figures/Singular/sing_in_all3vOpeque.eps}} \\
\multicolumn{2}{c}{\subcaptionbox{Singularities Combined\label{fig:sing_allTransp}}{\includegraphics[width = 0.7\linewidth]{figures/Singular/sing_all_transperent.eps}}}


\end{tabular}
\caption{Singular surface of variable speed control moment gyro in pyramid configuration.}
