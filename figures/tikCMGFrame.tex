...
% Text Node
\draw (422.88,69.43) node [anchor=north west][inner sep=0.75pt]  [font=\small] [align=left] {{\fontfamily{pcr}\selectfont {\small Gimble Frame }}};
% Text Node
\draw (260.21,145.43) node [anchor=north west][inner sep=0.75pt]  [font=\small] [align=left] {{\fontfamily{pcr}\selectfont {\small Body Frame}}};
% Text Node
...
% Text Node
\draw (55.1,289.64) node [anchor=north west][inner sep=0.75pt]  [font=\small] [align=left] {{\fontfamily{pcr}\selectfont {\small Inertial Frame }}};
% Text Node
...
% Text Node
\draw (76.18,311.83) node [anchor=north west][inner sep=0.75pt]    {$\mathcal{F}_{i}$};
% Text Node
\draw (277.18,169.83) node [anchor=north west][inner sep=0.75pt]    {$\mathcal{F}_{b}$};
% Text Node
