...
%Straight Lines [id:da49226350669274077] 
...
%Straight Lines [id:da13665506943907135] 
...
%Straight Lines [id:da25217164887241217] 
...
%Straight Lines [id:da08437972884775302] 
...
%Straight Lines [id:da5450396382078102] 
...
%Straight Lines [id:da9836811301294595] 
...
%Straight Lines [id:da3621893138287733] 
\draw    (341.17,148.01) -- (357.58,148.17) ;
%Straight Lines [id:da9797063309900802] 
\draw    (340.86,158.03) -- (357.58,148.17) ;
%Straight Lines [id:da37819716644239354] 
\draw    (318.62,146.33) -- (332.25,147.55) ;
%Straight Lines [id:da22184343767998893] 
\draw    (332.25,147.55) -- (340.86,158.03) ;
%Shape: Arc [id:dp3945865915606013] 
...
%Shape: Arc [id:dp10135606128333507] 
...
%Shape: Arc [id:dp8387827474135878] 
...
%Straight Lines [id:da4801164519167367] 
\draw    (411.14,4.55) -- (411.65,105.77) ;
%Straight Lines [id:da25322770164586794] 
\draw    (239.07,40.6) -- (240.43,310.29) ;
%Straight Lines [id:da10156454156698635] 
\draw    (239.07,40.6) -- (411.14,4.55) ;
%Straight Lines [id:da830511993873926] 
\draw    (240.43,310.29) -- (412.5,274.23) ;
%Straight Lines [id:da8647322746750348] 
\draw    (411.99,172.73) -- (412.5,274.23) ;
%Straight Lines [id:da21403494432443582] 
\draw  [dash pattern={on 4.5pt off 4.5pt}]  (411.65,105.77) -- (411.99,172.73) ;
%Shape: Arc [id:dp8403103633518745] 
...
% Text Node
\draw (441.66,162.98) node [anchor=north west][inner sep=0.75pt]    {$\hat{t}_{k}( \epsilon =+1)$};
% Text Node
\draw (258,210.4) node [anchor=north west][inner sep=0.75pt]    {$\hat{s}_{k} \ ( \epsilon =+1)$};
% Text Node
\draw (415,80.4) node [anchor=north west][inner sep=0.75pt]    {$-\hat{s}_{k} \ ( \epsilon =-1)$};
% Text Node
\draw (161,119.4) node [anchor=north west][inner sep=0.75pt]    {$-\hat{t}_{k}( \epsilon =-1)$};
% Text Node
\draw (247,71.4) node [anchor=north west][inner sep=0.75pt]    {$\hat{u}$};
% Text Node
\draw (335,24.4) node [anchor=north west][inner sep=0.75pt]    {$\hat{g}_{k}$};
